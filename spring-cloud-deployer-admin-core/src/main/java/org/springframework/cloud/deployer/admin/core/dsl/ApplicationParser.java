...
/**
 * Parser for application DSL that generates {@link AppNode}.
 *
 * @author Janne Valkealahti
 */
public class ApplicationParser extends AppParser {
	 ...
	 */
	public ApplicationParser(String dsl) {
		this(null, dsl);
	}
	 ...
	 */
	public ApplicationParser(String name, String dsl) {
