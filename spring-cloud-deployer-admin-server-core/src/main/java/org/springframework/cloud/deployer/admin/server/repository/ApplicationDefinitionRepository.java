...
public interface ApplicationDefinitionRepository extends PagingAndSortingRepository<ApplicationDefinition, String>{

	Page<ApplicationDefinition>search(SearchPageable searchPageable);
}
